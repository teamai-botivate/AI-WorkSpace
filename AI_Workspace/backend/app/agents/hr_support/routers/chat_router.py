...
from ..models.schemas import ChatMessage, ChatResponse, TokenPayload, ApprovalRequestCreate
from ..models.models import DatabaseConnection, RequestPriority, UserRole
from ..utils.auth import get_current_user
from ..agents.hr_agent import chat_with_agent
...
async def stream_chat(
    ...
    async def event_generator():
        ...
        try:
            ...
            from ..services.approval_service import get_employee_requests
...
async def send_message(
    ...
    if db_conn and schema_map:
        try:
            from ..models.schemas import VerifiedEmployeeRecord
            adapter = await get_adapter(db_conn.db_type, db_conn.connection_config)
