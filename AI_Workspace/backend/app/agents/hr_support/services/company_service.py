...
from ..models.models import Company, Policy, DatabaseConnection, PolicyType
...
from ..utils.email_service import send_auth_email, send_oauth_email
...
async def auto_provision_employees(
    ...
    if use_oauth or settings.smtp_user:
        for task in email_tasks:
            # Format the body
            from ..utils.email_service import WELCOME_TEMPLATE
        ...
        try:
            ...
            if password_key:
                ...
                if company and emp_record:
                    ...
                    if email_val:
                        from ..utils.email_service import PASSWORD_UPDATE_TEMPLATE
