...
# config.py is at backend/app/agents/resume_screening/core/config.py
# 1. dirname -> backend/app/agents/resume_screening/core
# 2. dirname -> backend/app/agents/resume_screening
# 3. dirname -> backend/app/agents
# 4. dirname -> backend/app
# 5. dirname -> backend
...
config_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))), "config.ini")
